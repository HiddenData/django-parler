...
class TranslatableQuerySetDefault(QuerySet):
    """
    ...
    def __init__(self, *args, **kwargs):
        super(TranslatableQuerySetDefault, self).__init__(*args, **kwargs)
        self._language = None


    def _clone(self, klass=None, setup=False, **kw):
        c = super(TranslatableQuerySetDefault, self)._clone(klass, setup, **kw)
    ...
    def create(self, **kwargs):
        ...
        return super(TranslatableQuerySetDefault, self).create(**kwargs)
    ...
    def iterator(self):
        ...
        base_iterator = super(TranslatableQuerySetDefault, self).iterator()
...
class JSONTranslatableQuerySet(TranslatableQuerySetDefault):
...
if appsettings.PARLER_BACKEND == 'json':
    TranslatableQuerySet = JSONTranslatableQuerySet
else:
    TranslatableQuerySet = TranslatableQuerySetDefault
